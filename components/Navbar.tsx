...
//                 animate={{ opacity: 1, y: 0 }}
//                 className="absolute right-0 top-12 w-48 rounded-lg shadow-lg bg-gray-800 border border-gray-700 overflow-hidden"
//               >
//                 <button
//                   onClick={() => {
...
//             className="md:hidden pb-4 space-y-2 border-t border-gray-700"
//           >
//             <button
//               onClick={() => {
//                 router.push('/admin/settings');
//                 setMobileMenu(false);
//               }}
//               className="block w-full text-left px-3 py-2 rounded-lg hover:bg-gray-700 text-white"
//             >
//               ⚙️ Settings
//             </button>
...
//             <button
//               onClick={handleLogout}
//               className="block w-full text-left px-3 py-2 rounded-lg hover:bg-red-600 text-white"
//             >
//               Logout
//             </button>
//           </motion.div>
